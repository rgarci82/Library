...
const AdminDashboard = () => {
    ...
    const confirmDelete = async () => {
        ...
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/${selectedItemDelete.itemType}/${id}`, {
                method: 'DELETE',
            });
    ...
    const handleAccept = async (requestID: number) => {
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/books/request/accept/${requestID}`, {
                method: 'PUT'
            })
    ...
    const handleMediaAccept = async (requestID: number) =>{
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/media/request/accept/${requestID}`, {
                method: 'PUT'
            })
            if (response.status === 200) {
    ...
    const handleDeviceAccept = async (requestID: number) => {
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/devices/request/accept/${requestID}`, {
                method: 'PUT'
            })
            if (response.status === 200) {
    ...
    const handleDeviceDeny = async (requestID: number) => {
        try{
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/devices/request/deny/${requestID}`, {
                method: 'PUT'
            })
            if (response.status === 200) {
                fetchDeviceRequests(); // Refresh the list after accepting
    ...
    const handleMediaDeny = async (requestID: number) => {
        try{
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/media/request/deny/${requestID}`, {
                method: 'PUT'
            })
            if (response.status === 200) {
                fetchMediaRequests(); // Refresh the list after accepting
    ...
    const handleDeny = async (requestID: number) => {
        try{
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/books/request/deny/${requestID}`, {
                method: 'PUT'
            })
            if (response.status === 200) {
                fetchBookRequests(); // Refresh the list after accepting
