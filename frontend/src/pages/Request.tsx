    ...
    if (step === 1) {
      ...
      if (itemType === 'Book') {
        try {
          ...
          toast.error(`Failed to create book request. Please try again.`, {
            position: "top-right",
            autoClose: 3000,
            hideProgressBar: false,
            closeOnClick: true,
        ...
        try {
          ...
          if (response.ok) {
            toast.success(`Media requested created successfully`, {
              position: "top-right",
              autoClose: 3000,
              hideProgressBar: false,
              closeOnClick: true,
          ...
          toast.error(`Failed to create media request. Please try again.`, {
            position: "top-right",
            autoClose: 3000,
            hideProgressBar: false,
            closeOnClick: true,
